...
def pad_input(input_,img_multiple_of=4):
...
def tile_eval(model, input_, tile=128, tile_overlap =32):
    ...
    tile = min(tile, h, w)
    assert tile % 4 == 0, "tile size should be multiple of 32"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt_name', type=str, default="BioIR5D.ckpt", help='checkpoint save path')
    ...
    net  = BioIRModel().load_from_checkpoint(ckpt_path).to(device)
    net.eval()
