...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_path', type=str, default="BioIR3D_results/", help='output save path')
    parser.add_argument('--ckpt_name', type=str, default="BioIR3D.ckpt", help='checkpoint save path')
